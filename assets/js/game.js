...
var fight = function(enemyName) {
    //repeat and execute as long as the enemy-robot ia alive
    while(playerHealth > 0 && enemyHealth > 0) {
        //place the code block here

        //window.alert("Welcome to Robot Gladiators!");

        //ask a player if they like to fight or skip
        var promptFight = window.prompt("Would you like to FIGHT or SKIP this battle? Enter 'FIGHT' or 'SKIP' to choose");

        //iif player picks "skip" confirm and then stop the loop
...
//pass the pickedEnemyName variable's value into the fight function, where it will assume the value of the enemyName parameter
    ...
    fight(pickedEnemyName[i]);
        ...
        window.alert("You have lost your Robot in bttle! Game Over!");
        break;
    }
}